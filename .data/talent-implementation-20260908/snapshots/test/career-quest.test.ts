...
const setup = (overrides: Record<string, unknown> = {}) => {
  ...
  const career = loadDeclarations('../src/game/career-quest.service.ts', ['baseProfessionNames', 'careerCharacterFor', 'guildCareerQuestFor', 'guildCareerMainQuest', 'advancedProfessionMainQuest'], { getPool: async () => pool, advancedProfessionByCode, worldTreeAdvancedProfessions, openingHubs });
