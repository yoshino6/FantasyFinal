...
const guildMapRisk = (maxLevel) => maxLevel === null || !Number.isFinite(maxLevel) || maxLevel < 1 ? '待勘测' : maxLevel < 20 ? '低危' : maxLevel <= 50 ? '中危' : '高危';
const guildMapCatalog = async (connection, hub) => {
...
export { guildMapCatalog, guildMapRegions, guildMapRisk };
