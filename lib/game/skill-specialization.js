...
import { folioHasGrowth } from './active-folio-skills.config.js';
...
const specializationOptions = (base, hasOrdinaryEffect = false) => {
    ...
    if (folioHasGrowth(base.code) || base.code.startsWith('hidden_') && !['hidden_catalyst', 'hidden_overclock', 'hidden_transfer', 'hidden_debug', 'hidden_finale'].includes(base.code) || supportGrowth.has(base.code) || ordinaryGrowth.has(base.code) || controlGrowth.has(base.code) || hasOrdinaryEffect)
        options.push('potent');
