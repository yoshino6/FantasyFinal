...
const excludedBossAchievementCode = (code) => ['dungeon_warden', 'scholar_ga', 'habadragon', 'goblin_royal_guard', 'goblin_royal_spearman'].includes(code) || code.startsWith('mentor_trial_') || code.startsWith('city_');
