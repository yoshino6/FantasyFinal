...
const replaceBossRandomEffectTrait = (traits, effect) => [
    ...traits.filter(trait => trait.code !== 'boss_random_effect'),
    ...(effect ? [effect] : [])
];
const rerollBossRandomEffectTrait = (traits, bossCode, difficultyCode, random = Math.random) => replaceBossRandomEffectTrait(traits, bossRandomEffectTrait(bossCode, difficultyCode, random));
...
export { bossCommonEffects, bossExclusiveEffects, bossRandomEffectDefinitions, bossRandomEffectTrait, hasBossRandomEffect, readBossRandomEffect, replaceBossRandomEffectTrait, rerollBossRandomEffectTrait };
