...
import { blindBoxBlueprints, constructionBlueprintCodes, blueprintRecipeCode } from './deconstructor-catalog.js';
...
const buyOddWorkshopItem = async (qqUserId, code) => withTransaction(async (connection) => {
    const character = await characterFor(connection, qqUserId, true);
    await requireAtNpc(connection, character, 'oddworkshop');
...
export { authorizeDungeonEntry, buyOddWorkshopItem, completeDungeonSecretForLeader, completeDungeonSecretPurchase, consultDungeonAtGuild, consultDungeonAtWorkshop, discoverDungeonEntrance, dungeonSecretProgress, entranceStory, markedDungeonEntrances, oddWorkshopDungeonCatalog, secondaryProfessionGuide };
