import { lamplightPrivateEcho } from './lamplight.config.js';
...
const lamplightEnding = (state, choices) => {
    const flags = typeof state.flags_json === 'string' ? JSON.parse(state.flags_json) : state.flags_json ?? {};
