...
class CombatRules {
    ...
    async afterHit(source, target, damage, element, skill, absorbed = 0, extra = false, magic = false) {
    ...
    async strike(source, original, power, element, magic, extra = false, forceHit = false, secondaryScale = 1, options = {}) {
        ...
        await this.afterHit(source, target, dealt - absorbed, element, isSkill, absorbed, extra, magic);
        return true;
    }
