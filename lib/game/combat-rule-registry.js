...
import { tenacityContest, bossControlChanceMultiplier, opposedChance, strikeCorrections, correctedHitChance, correctedCritChance, correctedCritBonus, opposedCritBonus } from './combat-math.js';
...
class CombatRules {
    ...
    async restore(source, target, hp, mp = 0, echo = false, maxHealing = Infinity) {
