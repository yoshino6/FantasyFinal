...
export declare const alchemyTacticByCode: Map<"quick_chant" | "defer" | "resistance" | "rescue" | "overflow" | "emergency" | "clean_shield" | "last_life" | "mana_spring" | "blood_mana" | "berserk" | "thorns" | "shed" | "lure" | "wind_charge" | "thunder_seed" | "oil" | "frost_crack" | "chain" | "antiheal" | "echo_damage" | "steal_light" | "reflect" | "chaos", {
    readonly code: "emergency";
    readonly name: "凝血救急剂";
    readonly tags: readonly ["生机", "凝胶"];
    readonly enemy: false;
