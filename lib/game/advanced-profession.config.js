...
const cachedAdvancedPassiveEffectFor = (professionCode) => {
    const effect = advancedProfessionByCode(String(professionCode ?? ''))?.passive.effect ?? {};
...
const advancedProfessionPassiveCodes = new Set(worldTreeAdvancedProfessions.map(profession => profession.passive.code));
...
export { activeSkillCodesForAdvancedProfession, advancedProfessionActiveSkillCodes, advancedProfessionByCode, advancedProfessionByMentor, advancedProfessionPassiveCodes, cachedAdvancedPassiveEffectFor, hasBattleOnlyAdvancedPassiveEffect, inheritancePassiveDefinitions, inheritancePassiveFor, isAdvancedProfessionSkillCode, isCachedAdvancedPassiveEffect, isCachedAdvancedPassiveKey, renameAdvancedMentorText, worldTreeAdvancedProfessions };
