...
export declare const pvpCombatAction: (qqUserId: string, type: "attack" | "skill" | "item" | "escape" | "auto" | "device", slot?: number, deviceSkillCode?: string, targetKind?: "member" | "target", automaticChant?: boolean) => Promise<{
    ended: boolean;
    log: string;
    settlement: string;
    requesterId: number;
