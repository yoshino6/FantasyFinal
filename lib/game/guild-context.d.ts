...
export declare const guildContextFor: (connection: OpeningConnection, characterId: number) => Promise<{
    code: OpeningHubCode;
    hub: {
        readonly name: "百纳镇";
...
export declare const requireGuildService: (connection: OpeningConnection, characterId: number) => Promise<{
    code: OpeningHubCode;
    hub: {
        readonly name: "百纳镇";
        readonly guild: "guild_counter";
...
export declare const requireCurrentGuild: (user: string) => Promise<{
    code: OpeningHubCode;
    hub: {
        readonly name: "百纳镇";
        readonly guild: "guild_counter";
