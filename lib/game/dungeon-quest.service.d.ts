...
export declare const studyWorkshopBlueprint: (qqUserId: string, code: string) => Promise<{
    name: string;
    price: number;
...
export declare const buyOddWorkshopItem: (user: string, code: string) => Promise<{
    name: string;
    price: number;
    rewardName: string | undefined;
}>;
