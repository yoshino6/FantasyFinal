...
const weaponMasteryBonusesFor = async (connection, characterId) => {
    ...
    const bonuses = { physicalAttackPct: 0, magicAttackPct: 0, physicalDefensePct: 0, magicDefensePct: 0, accuracyPct: 0, critRatePct: 0, critDamagePct: 0, critResistPct: 0, critDamageReductionPct: 0, mpPct: 0, chantSpeedPct: 0, details: [] };
...
export { applyWeaponMasteryStats, weaponMasteryBonusesFor };
