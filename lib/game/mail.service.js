    ...
    for (const attachment of attachments) {
        ...
        if (copperValue) {
            ...
            for (let index = 0; index < quantity; index += 1)
                await connection.execute(attachment.item_type === 'device' ? 'INSERT INTO player_item_instances (character_id,item_id) VALUES (?,?)' : 'INSERT INTO player_item_instances (character_id,item_id,quality,durability,durability_max) VALUES (?,?,100,100,100)', [characterId, attachment.id]);
        }
        else {
