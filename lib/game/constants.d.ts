...
export declare const legacyForgedEquipmentBase: (level: number, category: "\u6B66\u5668" | "\u9632\u5177") => number;
export declare const forgedEquipmentBase: (level: number, category: "\u6B66\u5668" | "\u9632\u5177", slot?: string) => number;
export declare const forgedPrimaryStats: (category: string, subtype: string, level: number, rarity: string, slot?: string) => Record<string, number>;
export declare const forgedAffixCap: (category: "\u6B66\u5668" | "\u9632\u5177", key: string, level: number, rarity: string) => number;
export declare const forgedEquipmentCaps: (category: "\u6B66\u5668" | "\u9632\u5177", level: number, rarity: string, primaryKeys: readonly string[], slot?: string) => Record<string, number>;
...
export declare const virtualEquipmentStats: (level: number, tier: VirtualEquipmentTier, physicalAttack: number, magicAttack: number, customLoadout?: VirtualEquipmentLoadout, armorBudget?: "monster" | "resident") => DerivedStats;
