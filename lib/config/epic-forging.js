...
const weaponMaterialFor = (weaponType) => weaponType === '匕首' ? 'tanned_spirit_leather' : weaponType === '法杖' || weaponType === '法书' || weaponType === '法球' ? 'spellcloth_bolt' : weaponType === '盾牌' ? 'cast_shell_plate' : 'bone_steel_plate';
