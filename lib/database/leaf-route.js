const initializeLeafRoute = async (pool) => {
    ...
    try {
        ...
        const [marker] = await c.execute("INSERT IGNORE INTO leaf_route_migrations(code) VALUES ('legacy_access_v1')");
