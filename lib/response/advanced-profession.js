...
import { advancedProfessionByCode, inheritancePassiveFor } from '../game/advanced-profession.config.js';
...
const advancedProfessionDetailFormat = async (qqUserId, mentorCode) => {
    ...
    const currentProfession = advancedProfessionByCode(completedCode ?? '');
...
const advancedMentorHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const advancedProfessionDetailHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await message.send({ format: await advancedProfessionDetailFormat(event.current.UserId, String(route.param('code'))) });
}
catch (error) {
    await fail(message, error);
} };
const inheritanceStudyHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const advancedMentorChatHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const acceptAdvancedProfessionHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const confirmAdvancedProfessionSwitchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const advanceAdvancedProfessionHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const submitAdvancedProfessionHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const beginInheritanceStudyHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const completeInheritanceStudyHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const toggleInheritanceStudyHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const startAdvancedProfessionTrialHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
