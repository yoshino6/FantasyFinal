...
const hunterLodgeHandler = async () => { const [event] = useEvent(); const [message] = useGameMessage(); try {
...
const hunterBuyHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useGameMessage(); try {
    await requireHunter(event.current.UserId);
...
const hunterBuySearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useGameMessage(); try {
    await requireHunter(event.current.UserId);
...
const hunterPurchaseHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useGameMessage(); try {
    await requireHunter(event.current.UserId);
...
const hunterSellHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useGameMessage(); try {
    await requireHunter(event.current.UserId);
...
const hunterSellSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useGameMessage(); try {
    await requireHunter(event.current.UserId);
...
const hunterSellItemHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useGameMessage(); try {
    await requireHunter(event.current.UserId);
    const amount = String(route.param('quantity') ?? '').trim();
...
const hunterChatHandler = async () => { const [event] = useEvent(); const [message] = useGameMessage(); try {
    await requireHunter(event.current.UserId);
