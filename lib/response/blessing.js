...
import { claimChurchBlessing } from '../game/blessing.service.js';
...
var blessing = async () => {
    ...
    try {
        ...
        await message.send({ format: messageFormat('祈福未完成', error instanceof Error ? error.message : '请稍后重试。') });
    }
};

export { blessing as default };
