...
const oddWorkshopSellPageHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireWorkshop(event.current.UserId);
...
const oddWorkshopSellSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireWorkshop(event.current.UserId);
...
const oddWorkshopSellItemHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireWorkshop(event.current.UserId);
