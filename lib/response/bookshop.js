...
const bookshopFormat = (text, chatting = false) => {
...
const bookshopHandler = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
    await message.send({ format: bookshopFormat() });
}
catch (error) {
    await message.send({ format: messageFormat('无法进入书屋', error instanceof Error ? error.message : '请稍后重试。') });
} };
const bookshopBuyHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
...
const bookshopBuySearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
...
const bookshopPurchaseHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
...
const bookshopSellHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
...
const bookshopSellSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
...
const bookshopSellItemHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
    const amount = String(route.param('quantity') ?? '').trim();
...
const bookshopChatHandler = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
    await requireBookshop(event.current.UserId);
    const affinity = await addNpcAffinity(event.current.UserId, code, 'chat');
    await message.send({ format: bookshopFormat(npcChatDialogue('bookshop', affinity.affinity), true) });
}
catch (error) {
    await message.send({ format: messageFormat('无法闲聊', error instanceof Error ? error.message : '请稍后重试。') });
} };
const readBookHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
