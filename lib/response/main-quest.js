...
import { contemplateSkyDust } from '../game/main-quest.service.js';
import { messageFormat } from '../game/message.js';

const contemplateSkyDustHandler = async () => {
    ...
    try {
        ...
        await message.send({ format: messageFormat('无法窥探', error instanceof Error ? error.message : '请稍后重试。') });
    }
};

export { contemplateSkyDustHandler };
