...
var mail = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
...
const mailPageHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await message.send({ format: await mailListFormat(event.current.UserId, Number(route.param('page') ?? 1), String(route.param('keyword') ?? '')) });
}
catch (error) {
    await message.send({ format: messageFormat('邮箱不可用', error instanceof Error ? error.message : '请稍后重试。') });
} };
const mailSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const mailDetailHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const mailClaimHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
...
const mailClaimAllHandler = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
...
const mailDeleteHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
