...
const requireGuildShop = (qqUserId) => requireNpcAtCurrentPosition(qqUserId, 'guild_counter');
const guildShopHandler = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
...
const shopBuyListHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireGuildShop(event.current.UserId);
...
const shopSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireGuildShop(event.current.UserId);
...
const shopPurchaseHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireGuildShop(event.current.UserId);
    ...
    await addNpcAffinity(event.current.UserId, 'guild_counter', 'buy');
...
const shopSellListHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireGuildShop(event.current.UserId);
...
const shopSellSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireGuildShop(event.current.UserId);
...
const shopSellHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await requireGuildShop(event.current.UserId);
    const requested = String(route.param('quantity') ?? '').trim();
    const result = await sellShopItem(event.current.UserId, Number(route.param('id')), requested ? Number(requested) : 1);
    await addNpcAffinity(event.current.UserId, 'guild_counter', 'sell');
...
const shopChatHandler = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
    await requireGuildShop(event.current.UserId);
    await addNpcAffinity(event.current.UserId, 'guild_counter', 'chat');
