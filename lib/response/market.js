...
const marketHomeHandler = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
...
const marketListHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketSellListHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketSellSearchHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketDetailHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketSellHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketBuyHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketOrdersHandler = async () => { const [event] = useEvent(); const [message] = useMessage(); try {
    await access(event.current.UserId);
...
const marketCancelHandler = async () => { const [event] = useEvent(); const [route] = useRoute(); const [message] = useMessage(); try {
    await access(event.current.UserId);
