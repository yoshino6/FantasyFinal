...
const forgeRequirements = (category: string, level: number) => {
  ...
  return ({
    ...
    15: [{ code: 'refined_iron', quantity: 5 }], 20: [{ code: 'refined_iron', quantity: 10 }],
    25: [{ code: 'star_copper', quantity: 5 }, { code: 'refined_iron', quantity: 10 }], 30: [{ code: 'star_copper', quantity: 10 }, { code: 'refined_iron', quantity: 20 }],
