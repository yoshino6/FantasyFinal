...
import { activeHeartQuestion, answerHeartQuestion, heartAttributeNames, openHeartQuestion, openQueuedHeartQuestion, skipHeartQuestion, type HeartTicket } from '../game/heart-question.service';
