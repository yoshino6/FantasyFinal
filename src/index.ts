...
appGroup.use({ path: '放入打造材料', schema: { usage: '/放入打造材料 <材料编号>', args: [{ name: 'id', rules: [{ required: true, type: 'number', min: 1 }] }] } }, () => import('./response/blacksmith').then(module => ({ default: module.forgeMaterialHandler })))
