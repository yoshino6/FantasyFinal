...
appGroup.use({ path: '家园家具', schema: { usage: '/家园家具 [楼层]', args: [{ name: 'floor', rules: [{ type: 'number', min: 1, max: 3 }] }] } }, () => import('./response/home').then(module => ({ default: module.homeFurnitureHandler })))
appGroup.use('家园制作清单', () => import('./response/home').then(module => ({ default: module.homeFurnitureHandler })))
