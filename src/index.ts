...
appGroup.use({ path: '家园制作', schema: { usage: '/家园制作 <家具代码> <楼层> <槽位>', args: [{ name: 'code', rules: [{ required: true }] }, { name: 'floor', rules: [{ required: true, type: 'number', min: 1, max: 3 }] }, { name: 'slot', rules: [{ required: true }] }] } }, () => import('./response/home').then(module => ({ default: module.homeCraftHandler })))
